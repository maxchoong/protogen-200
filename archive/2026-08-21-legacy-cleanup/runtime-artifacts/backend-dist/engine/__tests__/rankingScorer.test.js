...
describe('RankingScorer - Phase 3 Tests', () => {
    ...
    describe('ratingScore', () => {
        ...
        it('should return 0.5 for undefined/null', () => {
            ...
            expect(RankingScorer.ratingScore(null)).toBe(0.5);
        });
    ...
    describe('popularityScore', () => {
        ...
        it('should return 0.5 for undefined/null', () => {
            ...
            expect(RankingScorer.popularityScore(null)).toBe(0.5);
        });
    ...
    describe('recencyBoost', () => {
        ...
        it('should return 0.5 for undefined/null', () => {
            ...
            expect(RankingScorer.recencyBoost(null)).toBe(0.5);
        });
    });
    ...
    describe('rankTitles', () => {
        it('should sort titles by composite score descending', () => {
            ...
            expect(ranked[0].scoringFactors.composite).toBeGreaterThanOrEqual(ranked[1].scoringFactors.composite);
        });
