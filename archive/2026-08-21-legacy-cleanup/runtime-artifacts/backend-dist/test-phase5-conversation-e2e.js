...
async function testHighConfidenceMood() {
    try {
        ...
        const passed = response.recommendations &&
...
async function testAmbiguousQuery() {
    try {
        ...
        const passed = response.requiresClarification &&
...
async function testMultiTurnFlow() {
    try {
        ...
        const passed = round1.recommendations &&
...
async function testIntentMetadata() {
    try {
        ...
        const passed = response.detectedIntent &&
...
async function testRecommendationFields() {
    try {
        ...
        const hasRequiredFields = title.imdbId &&
            title.title &&
...
async function testNoRepeatClarification() {
    try {
        ...
        const passed = round2.recommendations &&
